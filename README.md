...
- [I. Exorcism Language Architecture](#i-exorcism-language-architecture)
  ...
  - [Runtime Environment Advantages](#runtime-environment-advantages)
    - [No Exorcism VM](#no-exorcism-vm)
    - [Cross-platform compilation](#cross-platform-compilation)
  - [How To Compile \& Run](#how-to-compile--run)
    - [Build](#build)
    - [Build \& Run](#build--run)
- [II. Exorcism Features \& Tooling](#ii-exorcism-features--tooling)
  - [Compiler Features](#compiler-features)
  - [Language Features](#language-features)
  - [Tooling](#tooling)
- [III. Exorcism Language Syntax](#iii-exorcism-language-syntax)
...
- [IV. What problems does Exorcism solve ?](#iv-what-problems-does-exorcism-solve-)
  - [1. A simple but powerful language design](#1-a-simple-but-powerful-language-design)
  - [2. Safer software development](#2-safer-software-development)
  - [3. Portable execution](#3-portable-execution)
  - [4. A foundation for experimenting with programming language features](#4-a-foundation-for-experimenting-with-programming-language-features)
